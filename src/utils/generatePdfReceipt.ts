...
export function downloadBillPdfReceipt(data: ReceiptData): void {
  ...
  doc.text('Retail Store Invoice / Cash Memo', pageWidth / 2, y, { align: 'center' });
  ...
  doc.text('Generated via GramMitra Shop Ledger', pageWidth / 2, y, { align: 'center' });
  ...
  doc.text(
    'Thank you for your visit! • Digitally generated via GramMitra Village Shop Khata',
    pageWidth / 2,
    pageHeight - 8,
    { align: 'center' }
  );
